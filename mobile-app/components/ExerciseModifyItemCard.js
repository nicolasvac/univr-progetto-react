...
const ExerciseModifyItemCard = ({ title, onDiscardChanges, onChangesConfirmed, types, item }) => {
    ...
    useEffect(() => {
        if (item) {
            setExerciseOfNow(item.exercise)
            setDurationOfNow(item.duration.toString())
        ...
        return (
            <View style={styles.card}>
                ...
                <View style={styles.row}>
                    <Text style={styles.labelDate}>{t("fooddiary:date")}</Text>
...
export default ExerciseModifyItemCard